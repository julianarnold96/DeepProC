...
1) negative samples (non-cleavage sites) remain unknown as only cleavage sites can measured -> negative labels need to be generated artificially, leaving us with an uncertainty in the negative labels
